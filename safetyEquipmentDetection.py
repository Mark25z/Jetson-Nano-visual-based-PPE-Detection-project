...
net = detectNet(model="models/safeUnsafe/ssd-mobilenet.onnx", labels="models/safeUnsafe/labels.txt", input_blob="input_0", output_cvg="scores", 
                    output_bbox="boxes", threshold=0.5)

# process frames until EOS or the user exits
# Led pin simulate warning for unsafe personel detection.
led_pin11 = 11
